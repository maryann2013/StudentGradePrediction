...
if (options =='Business Analytics for Student performance'):
    ...
    if st.sidebar.button('Predict'):  
        ...
        st.write('Final Grade would be : ', (prediction[0]/20)*100,'%')
    ...
    if uploaded_file is not None:
        ...
        if st.sidebar.button('Predict'):  
            ...
            for index, row in predicted_students_in_trouble.iterrows():
                studDet='<p style="font-family:Courier; color:Black; font-size: small;"><u>Student ID :</u></p>
                st.write(studDet, index,unsafe_allow_html=True)
                #st.write("--------------")
                for feat in key_features:
