...
st.title("Welcome to Student's Final Grade Prediction Web App")
...
options = st.selectbox("Please Select", ['PowerBI','Prediction'])

if (options =='PowerBI'):
   st.markdown("https://app.powerbi.com/view?r=eyJrIjoiNDU4NjMxODEtNGQ4OC00ODkxLThlOWYtODFiYjRmNDA0Yjk2IiwidCI6Ijk3YTkyYjA0LTRjODctNDM0MS05YjA4LWQ4MDUxZWY4ZGNlMiIsImMiOjh9&pageName=ReportSection",unsafe_allow_html=True)
else:
