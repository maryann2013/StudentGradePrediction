            ...
            for index, row in predicted_students_in_trouble.iterrows():
                ...
                for feat in key_features:
                    ...
                    if int(row_df[feat]) < student_por_df[feat].quantile(0.25):
                        studRisk='<p style="font-family:Courier; color:Black; font-size: small;">Below :'+feat+str(row_df[feat])+'Class:'+str(np.round(np.mean(student_por_df[feat]),2))+'</p>'
                    ...
                    if int(row_df[feat]) > student_por_df[feat].quantile(0.75):
                        studRisk='<p style="font-family:Courier; color:Black; font-size: small;">Above :'+feat+str(row_df[feat])+'Class:'+str(np.round(np.mean(student_por_df[feat]),2))+'</p>'
